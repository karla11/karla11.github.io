...
updated : 2022-06-28 02:32:20 +0900
tags    : 
toc     : true
public  : true
parent  : 
...
index 7238d1e5..30474929 100644
--- a/CMakeLists.txt
+++ b/CMakeLists.txt
@@ -1,5 +1,8 @@
...
index b1e8fc16..748a40f8 100644
--- a/examples/ftp/CMakeLists.txt
+++ b/examples/ftp/CMakeLists.txt
@@ -7,4 +7,5 @@ set(SRC ${SRCROOT}/Ftp.cpp)
...
index 8369a371..4e76506d 100644
--- a/examples/sound/CMakeLists.txt
+++ b/examples/sound/CMakeLists.txt
@@ -8,4 +8,5 @@ set(SRC ${SRCROOT}/Sound.cpp)
...
index 9012c77b..177c3bb4 100644
--- a/examples/voip/Server.cpp
+++ b/examples/voip/Server.cpp
@@ -191,7 +191,7 @@ void doServer(unsigned short port)
     std::cin.ignore(10000, '\n');
...
index 3cdbd68f..84dede57 100644
...
@@ -7,9 +8,11 @@ add_library(sfml-test-main STATIC
...
@@ -75,6 +84,7 @@ if(SFML_OS_WINDOWS AND NOT SFML_USE_SYSTEM_DEPS)
     )
 endif()
...
@@ -95,6 +105,7 @@ if(SFML_ENABLE_COVERAGE AND SFML_COMPILER_MSVC)
     )
 endif()
